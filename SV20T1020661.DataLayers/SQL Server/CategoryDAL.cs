    ...
    public class CategoryDAL : _BaseDAL, ICommonDAL<Category>
    {
        ...
        public Category? Get(int id)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                data = connection.QueryFirstOrDefault<Category>(sql: sql, param: parameters,
        ...
        public IList<Category> List(int page = 1, int pageSize = 0, string searchValue = "")
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                list = connection.Query<Category>(sql: sql, param: parameters, commandType: CommandType.Text)
                    .ToList();
                connection.Close();
            }
            return list;
